...
for _ in range(15000):
    ...
    if _%1000 == 0:
    	...
    	print('Training accuracy: ', sess.run(accuracy, feed_dict={X: train_x,
                                      y_: train_y}))
...
print('Cross Entropy: ', sess.run(cross_entropy, feed_dict={X: validate_x,
    								  y_: validate_y}))

#92% accuracy for the test set!
#pretty good but I'm gonna try to improve it
